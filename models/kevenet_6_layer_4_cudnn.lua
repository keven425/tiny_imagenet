function createModel(nGPU)
   ...
   fb1:add(cudnn.SpatialConvolution(3,64,5,5,1,1,2,2))       -- 64 -> 64      2/64
   fb1:add(cudnn.ReLU(true))
   fb1:add(cudnn.SpatialMaxPooling(2,2,2,2))                   -- 64 ->  32   
   fb1:add(cudnn.SpatialConvolution(64,64,5,5,1,1,2,2))       --  32 -> 32    2/32
   fb1:add(cudnn.ReLU(true))
   fb1:add(cudnn.SpatialMaxPooling(2,2,2,2))                   -- 32 ->  16   
   fb1:add(cudnn.SpatialConvolution(64,128,5,5,1,1,2,2))      --  16 ->  16   2/16
   fb1:add(cudnn.ReLU(true))
   fb1:add(cudnn.SpatialMaxPooling(2,2,2,2))                   -- 16 ->  8   
   fb1:add(cudnn.SpatialConvolution(128,256,5,5,1,1,2,2))      --  16 ->  16  2/16
   fb1:add(cudnn.ReLU(true))
   fb1:add(cudnn.SpatialMaxPooling(2,2,2,2))                   -- 8 ->  4   
