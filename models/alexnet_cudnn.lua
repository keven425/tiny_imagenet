function createModel(nGPU)
   ...
   fb1:add(cudnn.SpatialConvolution(3,48,11,11,4,4,2,2))       -- 224 -> 55   5/224
   fb1:add(cudnn.ReLU(true))
   fb1:add(cudnn.SpatialMaxPooling(3,3,2,2))                   -- 55 ->  27   
   fb1:add(cudnn.SpatialConvolution(48,128,5,5,1,1,2,2))       --  27 -> 27   2/27
   fb1:add(cudnn.ReLU(true))
   fb1:add(cudnn.SpatialMaxPooling(3,3,2,2))                   --  27 ->  13
   fb1:add(cudnn.SpatialConvolution(128,192,3,3,1,1,1,1))      --  13 ->  13  1/13
   fb1:add(cudnn.ReLU(true))
   fb1:add(cudnn.SpatialConvolution(192,192,3,3,1,1,1,1))      --  13 ->  13  1/13
   fb1:add(cudnn.ReLU(true))
   fb1:add(cudnn.SpatialConvolution(192,128,3,3,1,1,1,1))      --  13 ->  13  1/13
   fb1:add(cudnn.ReLU(true))
