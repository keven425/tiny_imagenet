function createModel(nGPU)
   ...
   fb1:add(cudnn.ReLU(true))
   fb1:add(nn.View(128*16*16))
   fb1:add(nn.Dropout(0.5))
   fb1:add(nn.Linear(128*16*16, 512))
   ...
   fb2:add(cudnn.ReLU(true))
   fb2:add(nn.View(128*16*16))
   fb2:add(nn.Dropout(0.5))
   fb2:add(nn.Linear(128*16*16, 512))
   ...
   fb3:add(cudnn.ReLU(true))
   fb3:add(nn.View(128*16*16))
   fb3:add(nn.Dropout(0.5))
   fb3:add(nn.Linear(128*16*16, 512))
   ...
   fb4:add(cudnn.ReLU(true))
   fb4:add(nn.View(128*8*8))
   fb4:add(nn.Dropout(0.5))
   fb4:add(nn.Linear(128*8*8, 512))
