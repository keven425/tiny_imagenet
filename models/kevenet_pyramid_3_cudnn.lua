function createModel(nGPU)
   ...
   fb11:add(cudnn.ReLU(true))
   fb11:add(nn.Reshape(128 * 16 * 16, true))
   ...
   fb12:add(cudnn.ReLU(true))
   fb12:add(nn.Reshape(128 * 16 * 16, true))
   ...
   fb13:add(cudnn.ReLU(true))
   fb13:add(nn.Reshape(128 * 16 * 16, true))
   ...
   fb4:add(cudnn.ReLU(true))
   fb4:add(nn.Reshape(128 * 8 * 8, true))
   ...
   classifier:add(nn.Linear(128*16*16 * 3 + 128 * 8 * 8, 1024))
